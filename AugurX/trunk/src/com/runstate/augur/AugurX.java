...
public class AugurX {
    ...
    public static String build = "svn revision 20";
    ...
    public static void main(String[] args) {
        ...
        if (MAC_OS_X) {
            ...
            // First we'll set some properties
            ...
            try {
                ...
                meth.invoke(app, new Object[]{img.getImage()});
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        if (lookandfeel != null && lookandfeel != UIManager.getSystemLookAndFeelClassName()) {
            try {
                ...
                System.err.println("Could Not Instansiate Look and Feel classes");
            } catch (IllegalAccessException e) {
                System.err.println("Illegal Access to Look and Feel classes");
            }
        }
