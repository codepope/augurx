...
public class TwixDoor extends Door {
    ...
    public boolean isMsgHot(Msg m) {
        if (m.getAuthor().equals(Controller.getProfile().get(Prefs.M_T_USERNAME))) {
            return true;
        }
        return false;
    }
        ...
        while (buffline != null || st.hasMoreTokens()) {
            ...
            if (line.equals("\n")) {
                ...
                if (multiline) {
                    ...
                    if (line.startsWith("http:") || line.startsWith("https:") || line.startsWith("twix:") || line.startsWith("mailto:")) {
                        htmlised.append("<A HREF='" + line + "'>" + StringEscapeUtils.escapeHtml(line) + "</A>");
                    } else if (line.startsWith("<http:") || line.startsWith("<https:") || line.startsWith("<twix:") || line.startsWith("<mailto:") || line.startsWith("<URL:http:") || line.startsWith("<URL:twix:") || line.startsWith("<URL:mailto:")) {
