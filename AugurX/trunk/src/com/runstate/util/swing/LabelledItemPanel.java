...
public class LabelledItemPanel extends JPanel
{
    ...
    public void addItem(String labelText, JComponent item)
    {
	    ...
	    public void addItem(String labelText, JComponent item,String sublabelText)
    {
        // Create the label and its constraints
        ...
        itemConstraints.gridx   = 1;
        itemConstraints.gridy   = myNextItemRow;
        itemConstraints.insets  = new Insets(10, 10, 0, 0);
		...
		sublabel.setFont(getFont());
        GridBagConstraints sublabelConstraints = new GridBagConstraints();

        sublabelConstraints.gridx   = 2;
        sublabelConstraints.gridy   = myNextItemRow;
		sublabelConstraints.weightx = 1.0;
        sublabelConstraints.insets  = new Insets(10, 10, 0, 10);
        sublabelConstraints.anchor  = GridBagConstraints.NORTHWEST;
        sublabelConstraints.fill    = GridBagConstraints.HORIZONTAL;

        add(sublabel, sublabelConstraints);
